...
export default function Layout({
  ...
  return (
    <div className='flex min-h-screen w-full flex-col bg-muted/40'>
      ...
      <div className={`flex min-w-0 flex-col pl-0 sm:gap-4 sm:py-4 sm:px-4 ${expanded ? 'sm:pl-52' : 'sm:pl-20'} transition-all duration-200`}>
        <header className='sticky top-0 z-30 flex flex-wrap items-center gap-4 border-b bg-background px-4 py-2 sm:static sm:h-auto sm:border-0 sm:bg-transparent sm:px-6'>
          <MobileNavLinks />
