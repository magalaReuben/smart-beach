    ...
    <Fragment>
      ...
      >
        <DialogContent className="max-h-full overflow-auto">
          {selectedServingGuest && (
            <DialogHeader>
              <DialogTitle>
                Guests seated at table {selectedTableNumber}
              </DialogTitle>
            </DialogHeader>
          )}
          <div>
                ...
                <div className="flex flex-col gap-2">
                  <TooltipProvider>
                    <Tooltip>
                      ...
                      <TooltipContent>
                        {getVietnameseOrderStatus(OrderStatus.Pending)}: {countObject[OrderStatus.Pending] ?? 0} orders
                      </TooltipContent>
                    </Tooltip>
                    ...
                    <Tooltip>
                      ...
                      <TooltipContent>
                        {getVietnameseOrderStatus(OrderStatus.Processing)}: {countObject[OrderStatus.Processing] ?? 0} orders
                      </TooltipContent>
                    </Tooltip>
                    <Tooltip>
                      <TooltipTrigger>
                      ...
                      <TooltipContent>
                        {getVietnameseOrderStatus(OrderStatus.Delivered)}: {countObject[OrderStatus.Delivered] ?? 0} orders
                      </TooltipContent>
                    </Tooltip>
                  </TooltipProvider>
                </div>
      ...
      <div className="flex justify-start items-end gap-4 flex-wrap py-4">
        {OrderStatusValues.map((status) => (
          <Badge
            key={status}
            className={getStatusBadgeClass(status as OrderStatusType)}
          >
